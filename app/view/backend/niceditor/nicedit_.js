...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : url_base + 'app/view/backend/niceditor/nicEditorIcons.gif',// hungtn updated 20131230
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	nicURI : 'http://api.imgur.com/2/upload.json',//base_url + '\\public\\upload\\', //'http://api.imgur.com/2/upload.json',
...
var nicCodeButton = nicEditorAdvancedButton.extend({
	...
	addPane : function() {
		this.addForm({
			...
			'code' : {type : 'content', 'value' : this.ne.selectedInstance.getContent(), style : {width: '490px', height : '200px'}}
		});
	},
